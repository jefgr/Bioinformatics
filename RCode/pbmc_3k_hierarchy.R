...
write.table(as.data.frame(hierarchy_list),file="2_hierarchy_list.csv", quote=F,sep=",",row.names=F,col.names = F)
write.table(as.data.frame(hierarchy_gene_list),file="2_hierarchy_gene_list.csv", quote=F,sep=",",row.names=F,col.names = F)
